...
@Named
@ViewScoped
@InfoPagina(nomeCurto = "gdpia", tags = {"gestao de personas ia"})
@InfoAcaoCRMAdmin(acao = FabAcaoCrmAdmin.PERSONA_IA_MB_GESTAO)
public class PgPersonaIA extends MB_paginaCadastroEntidades<Persona> {
