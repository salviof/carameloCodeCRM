...
@Named
@ViewScoped
@InfoPagina(nomeCurto = "ARQ_CV", tags = {"Arquivos do convidado"})
@InfoAcaoCRMConvidado(acao = FabAcaoCRMConvidado.ARQUIVO_MB_GESTAO)
public class PgArquivosDoConvidado extends MB_paginaCadastroEntidades<ArquivoAnexado> {
