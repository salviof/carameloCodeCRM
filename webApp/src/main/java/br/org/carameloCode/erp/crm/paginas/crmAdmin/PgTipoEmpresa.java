 ...
 */
@ViewScoped
@InfoAcaoCRMAdmin(acao = FabAcaoCrmAdmin.TIPO_EMPRESA_MB)
@InfoPagina(nomeCurto = "TpEmpresa", tags = {"Tipo Empresa"})
@Named
public class PgTipoEmpresa extends MB_paginaCadastroEntidades<TipoEmpresa> {
