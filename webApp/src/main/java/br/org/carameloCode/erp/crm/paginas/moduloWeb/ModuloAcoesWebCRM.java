 ...
 * @author sfurbino
 */
public class ModuloAcoesWebCRM extends ControllerAbstratoSBPersistencia {
        ...
        return new RespostaComGestaoEMRegraDeNegocioPadrao(getNovaRespostaAutorizaChecaNulo(pContato), pContato) {
            ...
            public void regraDeNegocio() throws ErroRegraDeNegocio {
                ...
                String conteudo = "Olá, você conhece o canal <a href='" + url + "'>  atendimento.casanovadigital.com.br </a>? "
                        ...
                        + "você pode efetuar seu primeiro acesso pelo link: <h1> "
                        + "<h1><a href='" + url + "' > LINK PRIMEIRO ACESSO RÁPIDO </a></h1>";

                try {
                    ERPCrm.CARAMELO_CODE_EXTENCAO.getImplementacaoDoContexto()
                            .enviarEMailAplicandoModeloAssinatura(usuario, pContato, "Acesse a àrea do cliente", conteudo);
    ...
    public static ItfRespostaAcaoDoSistema contatoAcessoAgendaEmail(final ContatoProspecto pContato) {
        return new RespostaComGestaoEMRegraDeNegocioPadrao(getNovaRespostaAutorizaChecaNulo(pContato), pContato) {
            ...
            public void regraDeNegocio() throws ErroRegraDeNegocio {
                ...
                try {
                    ERPCrm.CARAMELO_CODE_EXTENCAO.getImplementacaoDoContexto()
                            .enviarEMailAplicandoModeloAssinatura(usuarioLogado, pContato, "Acesse a àrea do cliente", conteudo);
