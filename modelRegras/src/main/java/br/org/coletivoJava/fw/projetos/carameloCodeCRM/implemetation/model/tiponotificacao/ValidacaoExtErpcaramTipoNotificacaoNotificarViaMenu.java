...
@ValidadorTipoNotificacao(validador = ValidadoresTipoNotificacao.NOTIFICARVIAMENU)
public class ValidacaoExtErpcaramTipoNotificacaoNotificarViaMenu
		extends
			ValidacaoTipoNotificacaoNotificarViaMenu {

	public ValidacaoExtErpcaramTipoNotificacaoNotificarViaMenu(
