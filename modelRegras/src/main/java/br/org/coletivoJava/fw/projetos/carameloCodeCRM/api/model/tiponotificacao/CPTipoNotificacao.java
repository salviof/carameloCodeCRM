...
public enum CPTipoNotificacao {
	_ID, _TIPOENTIDADE, _NOME, _ASSUNTO, _CONTEUDOHTML, _ACAOGATILHONOTIFICACAO, _NOMEFABRICAGATILHONOTICAO, _ACAOAUTOEXECUCAOENVIO, _NOMEFABRICAGATILHOACAOENVIADA, _ACAOAUTOEXECUCAOENTREGA, _NOMEFABRICAGATILHOACAOENTREGA, _ACAOAUTOEXECUCAOLEITURA, _NOMEFABRICAGATILHOACAOLEITURA, _EXIGIRRECIBODEENTREGA, _EXIGIRRECIBOLEITURA, _NOTIFICACAOUNICA, _NOTIFICARVIAMATRIX, _NOTIFICARVIAMENU, _NOTIFICARVIATELADEBLOQUEIO, _NOTIFICARVIAMOBILE, _NOTIFICARVIAWHATSAPP, _NOTIFICARVIAAPIPERSONALIZADA, _NOTIFICARVIASMS, _NOTIFICARVIAEMAIL, _REMETENTEAGUARDARESPOSTA, _MINUTOSRENOTIFICACAO, _DIASLOG, _ATIVO, _NOMEENTIDADEREFERENCIA, _CAMINHOUSUARIODESTINATARIO, _TIPOAGENTE, _ESTRUTURAENTIDADE, _ACAOESGATILHODISPONIVEIS, _ENTIDADESDISPONIVEIS, _ESTRATEGIA, _TIPONOTIFICACAONATIVA;
