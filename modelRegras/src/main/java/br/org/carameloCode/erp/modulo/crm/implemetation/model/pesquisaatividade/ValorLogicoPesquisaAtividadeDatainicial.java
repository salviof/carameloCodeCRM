...
@ValorLogicoPesquisaAtividade(calculo = ValoresLogicosPesquisaAtividade.DATAINICIAL)
public class ValorLogicoPesquisaAtividadeDatainicial
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoPesquisaAtividadeDatainicial(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getPesquisaAtividade().getDatainicial();
    }
