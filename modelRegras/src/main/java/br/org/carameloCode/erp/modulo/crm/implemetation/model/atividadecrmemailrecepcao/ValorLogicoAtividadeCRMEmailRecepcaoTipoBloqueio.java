...
@ValorLogicoAtividadeCRMEmailRecepcao(calculo = ValoresLogicosAtividadeCRMEmailRecepcao.TIPOBLOQUEIO)
public class ValorLogicoAtividadeCRMEmailRecepcaoTipoBloqueio
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoAtividadeCRMEmailRecepcaoTipoBloqueio(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getAticidade().getTipoBloqueio();
    }
