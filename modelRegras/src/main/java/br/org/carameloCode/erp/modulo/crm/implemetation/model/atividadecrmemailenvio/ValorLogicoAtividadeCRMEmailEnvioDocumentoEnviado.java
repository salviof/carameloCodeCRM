...
@ValorLogicoAtividadeCRMEmailEnvio(calculo = ValoresLogicosAtividadeCRMEmailEnvio.DOCUMENTOENVIADO)
public class ValorLogicoAtividadeCRMEmailEnvioDocumentoEnviado
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoAtividadeCRMEmailEnvioDocumentoEnviado(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
