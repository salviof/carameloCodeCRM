...
@ValorLogicoReservaHoraRemotoVideo(calculo = ValoresLogicosReservaHoraRemotoVideo.CHAVEPIX)
public class ValorLogicoReservaHoraRemotoVideoChavePix
		extends
			ValorLogicoCalculoGenerico {

	public ValorLogicoReservaHoraRemotoVideoChavePix(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
