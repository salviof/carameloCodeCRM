...
@ValorLogicoPessoa(calculo = ValoresLogicosPessoa.USUARIOATENDIMENTO)
public class ValorLogicoPessoaUsuarioAtendimento
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoPessoaUsuarioAtendimento(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public Object getValor(Object... pEntidade) {
        ...
        return getPessoa().getUsuarioAtendimento();
    }
