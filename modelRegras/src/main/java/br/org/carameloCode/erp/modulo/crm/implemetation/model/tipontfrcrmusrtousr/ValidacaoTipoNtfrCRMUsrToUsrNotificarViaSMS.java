...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.NOTIFICARVIASMS)
public class ValidacaoTipoNtfrCRMUsrToUsrNotificarViaSMS
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrNotificarViaSMS(
