...
@ValorLogicoAtividadeCrmLicacaoRealizada(calculo = ValoresLogicosAtividadeCrmLicacaoRealizada.RELACIONAMENTOGERADO)
public class ValorLogicoAtividadeCrmLicacaoRealizadaRelacionamentoGerado
		extends
			ValorLogicoCalculoGenerico {

	ValorLogicoAtividadeCrmLicacaoRealizadaRelacionamentoGerado(
