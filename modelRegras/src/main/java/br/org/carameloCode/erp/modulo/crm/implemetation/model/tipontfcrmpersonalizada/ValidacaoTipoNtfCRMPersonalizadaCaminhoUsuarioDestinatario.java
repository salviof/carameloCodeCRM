...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.CAMINHOUSUARIODESTINATARIO)
public class ValidacaoTipoNtfCRMPersonalizadaCaminhoUsuarioDestinatario
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaCaminhoUsuarioDestinatario(
	...
	public List validar(java.lang.Object o) throws ErroValidacao {
		CarameloCode
				...
				.enviarMsgErroAoUsuario(
						"A Validação do campo  Origem usuário Destinatário não foi implementada");
