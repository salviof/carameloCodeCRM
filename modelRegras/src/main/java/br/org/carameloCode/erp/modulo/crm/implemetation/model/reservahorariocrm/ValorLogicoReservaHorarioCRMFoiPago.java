...
@ValorLogicoReservaHorarioCRM(calculo = ValoresLogicosReservaHorarioCRM.FOIPAGO)
public class ValorLogicoReservaHorarioCRMFoiPago
		extends
			ValorLogicoCalculoGenerico {

	public ValorLogicoReservaHorarioCRMFoiPago(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
