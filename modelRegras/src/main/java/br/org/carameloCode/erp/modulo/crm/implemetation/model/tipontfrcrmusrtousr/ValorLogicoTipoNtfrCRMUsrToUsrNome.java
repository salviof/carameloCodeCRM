...
@ValorLogicoTipoNtfrCRMUsrToUsr(calculo = ValoresLogicosTipoNtfrCRMUsrToUsr.NOME)
public class ValorLogicoTipoNtfrCRMUsrToUsrNome
		extends
			ValorLogicoCalculoGenerico {

	public ValorLogicoTipoNtfrCRMUsrToUsrNome(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
