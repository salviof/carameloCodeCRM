...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.NOTIFICARVIATELADEBLOQUEIO)
public class ValidacaoTipoNtfCRMPersonalizadaNotificarViaTelaDeBLoqueio
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaNotificarViaTelaDeBLoqueio(
	...
	public List validar(java.lang.Object o) throws ErroValidacao {
		CarameloCode.getServicoMensagemFireForget().enviarMsgErroAoUsuario(
				"A Validação do campo  Via Tela Bloqueio não foi implementada");
