...
public class DocsClienteDaCategoria {
    ...
    private CategoriaArquivoCliente categoria;

    @InfoCampo(tipo = FabTipoAtributoObjeto.LISTA_OBJETOS_PUBLICOS)
    private List<ArquivoCliente> arquivoAnexado;
    ...
    public CategoriaArquivoCliente getCategoria() {
        return categoria;
    }

    public void setCategoria(CategoriaArquivoCliente categoria) {
        this.categoria = categoria;
    }

    public List<ArquivoCliente> getArquivoAnexado() {
        return arquivoAnexado;
    }

    public void setArquivoAnexado(List<ArquivoCliente> arquivoAnexado) {
