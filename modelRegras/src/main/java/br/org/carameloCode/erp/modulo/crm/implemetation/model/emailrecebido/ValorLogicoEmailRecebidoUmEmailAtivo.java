...
@ValorLogicoEmailRecebido(calculo = ValoresLogicosEmailRecebido.UMEMAILATIVO)
public class ValorLogicoEmailRecebidoUmEmailAtivo
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailRecebidoUmEmailAtivo(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
