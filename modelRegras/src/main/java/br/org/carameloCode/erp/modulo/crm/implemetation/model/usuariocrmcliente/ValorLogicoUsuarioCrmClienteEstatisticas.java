...
@ValorLogicoUsuarioCrmCliente(calculo = ValoresLogicosUsuarioCrmCliente.ESTATISTICAS)
public class ValorLogicoUsuarioCrmClienteEstatisticas
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoUsuarioCrmClienteEstatisticas(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getUsuarioCliente().getEstatisticas();
    }
