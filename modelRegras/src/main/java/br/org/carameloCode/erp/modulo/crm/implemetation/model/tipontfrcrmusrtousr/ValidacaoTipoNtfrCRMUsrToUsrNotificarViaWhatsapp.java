...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.NOTIFICARVIAWHATSAPP)
public class ValidacaoTipoNtfrCRMUsrToUsrNotificarViaWhatsapp
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrNotificarViaWhatsapp(
