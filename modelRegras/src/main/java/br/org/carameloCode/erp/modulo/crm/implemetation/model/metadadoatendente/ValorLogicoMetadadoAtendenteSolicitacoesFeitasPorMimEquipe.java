...
@ValorLogicoMetadadoAtendente(calculo = ValoresLogicosMetadadoAtendente.SOLICITACOESFEITASPORMIMEQUIPE)
public class ValorLogicoMetadadoAtendenteSolicitacoesFeitasPorMimEquipe
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoMetadadoAtendenteSolicitacoesFeitasPorMimEquipe(
    ...
    public Object getValor(Object... pEntidade) {
        ...
        try {
            String jpql = "SELECT COUNT(s) FROM Solicitacao s "
                    ...
                    + "AND s.tipoEntitySoliciatacao NOT IN ('SolicitacaoArquivoCliente', 'SolicitacaoConfirmacaoCliente')";

            Long quantidade = em.createQuery(jpql, Long.class)
                    .setParameter("usuarioLogado", getMetadadoAtendente().getUsuario())
                    .getSingleResult();
            getMetadadoAtendente().setSolicitacoesFeitasPorMimEquipe(quantidade.intValue());
        } finally {

        }
        return getMetadadoAtendente().getSolicitacoesFeitasPorMimEquipe();
    }
