...
@ValorLogicoUsuarioCrmCliente(calculo = ValoresLogicosUsuarioCrmCliente.CAIXAPOSTALPRINCIPAL)
public class ValorLogicoUsuarioCrmClienteCaixaPostalPrincipal
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoUsuarioCrmClienteCaixaPostalPrincipal(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getUsuarioCliente().getCaixaPostalPrincipal();
    }
