...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.ESTRUTURAENTIDADE)
public class ValidacaoTipoNtfCRMPersonalizadaEstruturaEntidade
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaEstruturaEntidade(
	...
	public List validar(java.lang.Object o) throws ErroValidacao {
		CarameloCode
				...
				.enviarMsgErroAoUsuario(
						"A Validação do campo  Estrutura Entidade não foi implementada");
