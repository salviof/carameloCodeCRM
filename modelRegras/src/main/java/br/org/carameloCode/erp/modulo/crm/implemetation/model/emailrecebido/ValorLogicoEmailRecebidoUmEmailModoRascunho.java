...
@ValorLogicoEmailRecebido(calculo = ValoresLogicosEmailRecebido.UMEMAILMODORASCUNHO)
public class ValorLogicoEmailRecebidoUmEmailModoRascunho
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailRecebidoUmEmailModoRascunho(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
