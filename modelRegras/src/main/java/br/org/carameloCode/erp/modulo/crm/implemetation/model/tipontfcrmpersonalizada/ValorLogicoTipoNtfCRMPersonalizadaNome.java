...
@ValorLogicoTipoNtfCRMPersonalizada(calculo = ValoresLogicosTipoNtfCRMPersonalizada.NOME)
public class ValorLogicoTipoNtfCRMPersonalizadaNome
		extends
			ValorLogicoCalculoGenerico {

	public ValorLogicoTipoNtfCRMPersonalizadaNome(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
