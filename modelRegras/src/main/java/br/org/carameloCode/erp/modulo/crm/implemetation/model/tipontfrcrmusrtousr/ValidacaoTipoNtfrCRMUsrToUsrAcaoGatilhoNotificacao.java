...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.ACAOGATILHONOTIFICACAO)
public class ValidacaoTipoNtfrCRMUsrToUsrAcaoGatilhoNotificacao
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrAcaoGatilhoNotificacao(
