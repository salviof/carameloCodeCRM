...
public enum CPMensagemMktWhatsapp {
	_ID, _TIPO, _PESSOA, _TELEFONE, _CONTATO, _DATAHORA, _RECIBOENVIO, _ENVIADO, _RECEBIDO, _LIDO, _DISPAROEMMASSA, _ATIVIDADE, _LINKPREVIEW;
	...
	public static final String disparoemmassa = "disparoEmMassa";
