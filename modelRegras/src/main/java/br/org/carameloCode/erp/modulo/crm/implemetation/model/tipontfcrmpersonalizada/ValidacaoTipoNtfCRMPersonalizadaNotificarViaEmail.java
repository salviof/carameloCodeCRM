...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.NOTIFICARVIAEMAIL)
public class ValidacaoTipoNtfCRMPersonalizadaNotificarViaEmail
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaNotificarViaEmail(
