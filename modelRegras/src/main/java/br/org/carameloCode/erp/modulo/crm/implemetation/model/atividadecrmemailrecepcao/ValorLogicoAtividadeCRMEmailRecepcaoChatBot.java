...
@ValorLogicoAtividadeCRMEmailRecepcao(calculo = ValoresLogicosAtividadeCRMEmailRecepcao.CHATBOT)
public class ValorLogicoAtividadeCRMEmailRecepcaoChatBot
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoAtividadeCRMEmailRecepcaoChatBot(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
