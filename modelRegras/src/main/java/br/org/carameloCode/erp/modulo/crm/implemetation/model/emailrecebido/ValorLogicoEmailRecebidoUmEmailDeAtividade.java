...
@ValorLogicoEmailRecebido(calculo = ValoresLogicosEmailRecebido.UMEMAILDEATIVIDADE)
public class ValorLogicoEmailRecebidoUmEmailDeAtividade
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailRecebidoUmEmailDeAtividade(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        setValorPorReflexao(false);
        return false;
    }
