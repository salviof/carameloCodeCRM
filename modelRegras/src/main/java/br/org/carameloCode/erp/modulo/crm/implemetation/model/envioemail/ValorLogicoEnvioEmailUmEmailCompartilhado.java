...
@ValorLogicoEnvioEmail(calculo = ValoresLogicosEnvioEmail.UMEMAILCOMPARTILHADO)
public class ValorLogicoEnvioEmailUmEmailCompartilhado
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEnvioEmailUmEmailCompartilhado(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
