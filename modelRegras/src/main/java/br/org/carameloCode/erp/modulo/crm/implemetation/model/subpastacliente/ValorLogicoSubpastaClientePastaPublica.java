...
@ValorLogicoSubpastaCliente(calculo = ValoresLogicosSubpastaCliente.PASTAPUBLICA)
public class ValorLogicoSubpastaClientePastaPublica
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoSubpastaClientePastaPublica(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
