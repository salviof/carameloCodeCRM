...
@ValorLogicoAtividadeCRMEmailEnvio(calculo = ValoresLogicosAtividadeCRMEmailEnvio.CHATBOT)
public class ValorLogicoAtividadeCRMEmailEnvioChatBot
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoAtividadeCRMEmailEnvioChatBot(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
