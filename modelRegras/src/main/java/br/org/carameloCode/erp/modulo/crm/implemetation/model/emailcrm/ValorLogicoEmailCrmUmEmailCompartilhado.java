...
@ValorLogicoEmailCrm(calculo = ValoresLogicosEmailCrm.UMEMAILCOMPARTILHADO)
public class ValorLogicoEmailCrmUmEmailCompartilhado
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailCrmUmEmailCompartilhado(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
