...
@ValidadorTipoAtvChamadaRealizada(validador = ValidadoresTipoAtvChamadaRealizada.MODELOEMAIL)
public class ValidacaoTipoAtvChamadaRealizadaModeloEmail
		extends
			ValidacaoGenerica<TipoAtvChamadaRealizada> {

	public ValidacaoTipoAtvChamadaRealizadaModeloEmail(
