...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.ACAOGATILHONOTIFICACAO)
public class ValidacaoTipoNtfCRMPersonalizadaAcaoGatilhoNotificacao
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaAcaoGatilhoNotificacao(
	...
	public List validar(java.lang.Object o) throws ErroValidacao {
		CarameloCode
				...
				.enviarMsgErroAoUsuario(
						"A Validação do campo  Gatilho de Notificação não foi implementada");
