...
@ValorLogicoEnvioEmailAtividade(calculo = ValoresLogicosEnvioEmailAtividade.ICONETIPOEMAIL)
public class ValorLogicoEnvioEmailAtividadeIconeTipoEmail
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEnvioEmailAtividadeIconeTipoEmail(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
