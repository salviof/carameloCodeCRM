...
@ValorLogicoSolicitArqAtualizacaoEqp(calculo = ValoresLogicosSolicitArqAtualizacaoEqp.NOTIFICACAO)
public class ValorLogicoSolicitArqAtualizacaoEqpNotificacao
        extends
        ValorLogicoSolicitacaoNotificacao {

    public ValorLogicoSolicitArqAtualizacaoEqpNotificacao(
