...
@ValorLogicoPessoa(calculo = ValoresLogicosPessoa.UMPERFILPUBLICO)
public class ValorLogicoPessoaUmPerfilPublico
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoPessoaUmPerfilPublico(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getPessoa().isUmPerfilPublico();
    }
