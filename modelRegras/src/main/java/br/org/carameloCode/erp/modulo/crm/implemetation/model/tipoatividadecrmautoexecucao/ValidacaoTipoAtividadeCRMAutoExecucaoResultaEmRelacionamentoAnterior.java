...
@ValidadorTipoAtividadeCRMAutoExecucao(validador = ValidadoresTipoAtividadeCRMAutoExecucao.RESULTAEMRELACIONAMENTOANTERIOR)
public class ValidacaoTipoAtividadeCRMAutoExecucaoResultaEmRelacionamentoAnterior extends ValidacaoGenerica<TipoAtividadeCRMAutoExecucao> {

    public ValidacaoTipoAtividadeCRMAutoExecucaoResultaEmRelacionamentoAnterior(
