...
@ValidadorEscopoPesquisaMelhorHorario(validador = ValidadoresEscopoPesquisaMelhorHorario.DIASEMANADOMINGO)
public class ValidacaoEscopoPesquisaMelhorHorarioDiaSemanaDomingo extends ValidacaoGenerica<EscopoPesquisaMelhorHorario> {

    public ValidacaoEscopoPesquisaMelhorHorarioDiaSemanaDomingo(
    ...
    public List<WidgetsFormulario> validar(Object pValor) throws ErroValidacao {
        ...
        String diasSemanaAtualizado
                = ValidacaoDisponibilidadeAtdmtPublicoDiasDaSemana
                        .definirValor(getEscopoPesquisaMelhorHorario().getDiasDaSemana(), DayOfWeek.SUNDAY.getValue(), ativo);
        getEscopoPesquisaMelhorHorario().setDiasDaSemana(diasSemanaAtualizado);
        getEscopoPesquisaMelhorHorario().setDiaSemanaDomingo(ativo);
