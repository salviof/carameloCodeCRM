...
@ValidadorEmailRecebido(validador = ValidadoresEmailRecebido.ASSUNTO)
public class ValidacaoEmailRecebidoAssunto extends ValidacaoGenerica<EmailRecebido> {

    public ValidacaoEmailRecebidoAssunto(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
