...
@ValorLogicoEnvioEmailAtividade(calculo = ValoresLogicosEnvioEmailAtividade.UMACONVERSAEXTERNA)
public class ValorLogicoEnvioEmailAtividadeUmaConversaExterna
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEnvioEmailAtividadeUmaConversaExterna(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        getEnvioEmail().setUmaConversaExterna(true);
        return getEnvioEmail().isUmaConversaExterna();
    }
