...
@ValorLogicoEmailCrm(calculo = ValoresLogicosEmailCrm.UMEMAILATIVO)
public class ValorLogicoEmailCrmUmEmailAtivo extends ValorLogicoCalculoGenerico {

    public ValorLogicoEmailCrmUmEmailAtivo(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
