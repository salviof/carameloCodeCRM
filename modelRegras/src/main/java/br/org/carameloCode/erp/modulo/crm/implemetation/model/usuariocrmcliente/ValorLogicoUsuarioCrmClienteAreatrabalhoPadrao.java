...
@ValorLogicoUsuarioCrmCliente(calculo = ValoresLogicosUsuarioCrmCliente.AREATRABALHOPADRAO)
public class ValorLogicoUsuarioCrmClienteAreatrabalhoPadrao
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoUsuarioCrmClienteAreatrabalhoPadrao(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getUsuarioCliente().getAreatrabalhoPadrao();
    }
