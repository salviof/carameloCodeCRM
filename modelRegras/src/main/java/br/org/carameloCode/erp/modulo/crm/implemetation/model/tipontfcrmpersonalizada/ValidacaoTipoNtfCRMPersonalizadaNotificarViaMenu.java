...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.NOTIFICARVIAMENU)
public class ValidacaoTipoNtfCRMPersonalizadaNotificarViaMenu
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaNotificarViaMenu(
