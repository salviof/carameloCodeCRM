...
@ValorLogicoPessoaFisica(calculo = ValoresLogicosPessoaFisica.SERVICOS)
public class ValorLogicoPessoaFisicaServicos extends ValorLogicoCalculoGenerico {

    public ValorLogicoPessoaFisicaServicos(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
