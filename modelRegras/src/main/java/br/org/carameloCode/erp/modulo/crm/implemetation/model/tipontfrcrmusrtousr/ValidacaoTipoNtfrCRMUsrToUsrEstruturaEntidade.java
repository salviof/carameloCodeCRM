...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.ESTRUTURAENTIDADE)
public class ValidacaoTipoNtfrCRMUsrToUsrEstruturaEntidade
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrEstruturaEntidade(
