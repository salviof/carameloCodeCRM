...
@ValorLogicoSolicitacaoArquivoEquipe(calculo = ValoresLogicosSolicitacaoArquivoEquipe.EMATRASO)
public class ValorLogicoSolicitacaoArquivoEquipeEmAtraso
		extends
			ValorLogicoCalculoGenerico {

	public ValorLogicoSolicitacaoArquivoEquipeEmAtraso(
