...
@ValorLogicoTipoServico(calculo = ValoresLogicosTipoServico.TEMINTEGRACAOFATURA)
public class ValorLogicoTipoServicoTemIntegracaoFatura
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoTipoServicoTemIntegracaoFatura(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public Object getValor(Object... pEntidade) {
        ...
        if (isCacheAtivado()) {
            ...
            if (pesquisaSistema.isPresent()) {
                ...
                if (codigo != null) {
                    getTipoServico().setTemIntegracaoFatura(true);
                }
            }
        ...
        return getTipoServico().isTemIntegracaoFatura();
    }
