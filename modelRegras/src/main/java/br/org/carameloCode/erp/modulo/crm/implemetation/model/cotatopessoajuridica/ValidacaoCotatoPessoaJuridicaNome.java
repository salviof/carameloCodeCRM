...
@ValidadorCotatoPessoaJuridica(validador = ValidadoresCotatoPessoaJuridica.NOME)
public class ValidacaoCotatoPessoaJuridicaNome extends ValidacaoGenerica<CotatoPessoaJuridica> {

    public ValidacaoCotatoPessoaJuridicaNome(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
