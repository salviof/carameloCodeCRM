...
public enum CPTipoDadoIA {
	_MODEL, _TEMPERATURA, _PERSONAIA, _IMPLEMENTACAOPADRAO, _ENVIARHISTORICO, _ENVIARDADOSDEATIVIDADE, _TOP_P, _MAXIMOTOKENS, _TIMEOUT, _PRESENCE_PENALTY, _FREQUENCY_PENALTY, _CONTEXT_POLICY, _FALLBACK_MODEL, _MONTHLY_TOKEN_LIMIT, _ATIVO, _CONTEUDOPERGUNTAIA, _CONTEUDOALTERNATIVOCASOFALHA, _TIPODADOLOGICACASOFALHA;

	public static final String model = "model";
	public static final String temperatura = "temperatura";
	public static final String personaia = "personaIA";
