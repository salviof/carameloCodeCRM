...
import br.org.carameloCode.erp.modulo.agenda.implemetation.model.disponibilidadeatdmtpublico.ValidacaoDisponibilidadeAtdmtPublicoDiasDaSemana;
import br.org.carameloCode.erp.modulo.agenda.entidadesJPA.escopoPesquisa.EscopoPesquisaMelhorHorario;

@ValidadorEscopoPesquisaMelhorHorario(validador = ValidadoresEscopoPesquisaMelhorHorario.DIASEMANASEGUNDA)
public class ValidacaoEscopoPesquisaMelhorHorarioDiaSemanaSegunda extends ValidacaoGenerica<EscopoPesquisaMelhorHorario> {

    public ValidacaoEscopoPesquisaMelhorHorarioDiaSemanaSegunda(
    ...
    public List<WidgetsFormulario> validar(Object pValor) throws ErroValidacao {
        ...
        String diasSemanaAtualizado
                = ValidacaoDisponibilidadeAtdmtPublicoDiasDaSemana
                        .definirValor(getEscopoPesquisaMelhorHorario().getDiasDaSemana(), DayOfWeek.MONDAY.getValue(), ativo);
        getEscopoPesquisaMelhorHorario().setDiasDaSemana(diasSemanaAtualizado);
        getEscopoPesquisaMelhorHorario().setDiaSemanaSegunda(ativo);
