...
@ValorLogicoTipoServicoRecorrente(calculo = ValoresLogicosTipoServicoRecorrente.CODIGOITENGRACAOFATURA)
public class ValorLogicoTipoServicoRecorrenteCodigoItengracaoFatura
        extends
        ValorLogicoTipoServicoCodigoItengracaoFatura {

    public ValorLogicoTipoServicoRecorrenteCodigoItengracaoFatura(
