...
@ValorLogicoPessoaJuridica(calculo = ValoresLogicosPessoaJuridica.ATENDENTELOGADORESPONSAVELPRINCIPAL)
public class ValorLogicoPessoaJuridicaAtendenteLogadoResponsavelPrincipal
        extends
        ValorLogicoPessoaAtendenteLogadoResponsavelPrincipal {

    public ValorLogicoPessoaJuridicaAtendenteLogadoResponsavelPrincipal(
