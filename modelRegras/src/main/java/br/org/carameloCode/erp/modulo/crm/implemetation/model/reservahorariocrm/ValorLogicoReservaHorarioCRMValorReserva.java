...
@ValorLogicoReservaHorarioCRM(calculo = ValoresLogicosReservaHorarioCRM.VALORRESERVA)
public class ValorLogicoReservaHorarioCRMValorReserva
		extends
			ValorLogicoCalculoGenerico {

	public ValorLogicoReservaHorarioCRMValorReserva(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
