...
@ValorLogicoEmailCrm(calculo = ValoresLogicosEmailCrm.UMEMAILRECEBIDO)
public class ValorLogicoEmailCrmUmEmailRecebido
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailCrmUmEmailRecebido(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
