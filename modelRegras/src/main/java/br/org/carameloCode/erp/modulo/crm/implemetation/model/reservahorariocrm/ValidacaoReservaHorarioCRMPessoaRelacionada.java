...
@ValidadorReservaHorarioCRM(validador = ValidadoresReservaHorarioCRM.PESSOARELACIONADA)
public class ValidacaoReservaHorarioCRMPessoaRelacionada
		extends
			ValidacaoGenerica<ReservaHorarioCRM> {

	public ValidacaoReservaHorarioCRMPessoaRelacionada(
