...
@ValorLogicoEmailCrm(calculo = ValoresLogicosEmailCrm.UMEMAILPRIVADO)
public class ValorLogicoEmailCrmUmEmailPrivado
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailCrmUmEmailPrivado(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
