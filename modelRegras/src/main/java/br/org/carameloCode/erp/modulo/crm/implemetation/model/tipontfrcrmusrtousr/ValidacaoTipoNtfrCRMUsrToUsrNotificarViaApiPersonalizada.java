...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.NOTIFICARVIAAPIPERSONALIZADA)
public class ValidacaoTipoNtfrCRMUsrToUsrNotificarViaApiPersonalizada
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrNotificarViaApiPersonalizada(
