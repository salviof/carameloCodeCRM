...
@ValorLogicoUsuarioCrmCliente(calculo = ValoresLogicosUsuarioCrmCliente.ASSINATURAEMAIL)
public class ValorLogicoUsuarioCrmClienteAssinaturaEmail
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoUsuarioCrmClienteAssinaturaEmail(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getUsuarioCliente().getAssinaturaEmail();
    }
