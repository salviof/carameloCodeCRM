...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.NOME)
public class ValidacaoTipoNtfrCRMUsrToUsrNome
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrNome(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
