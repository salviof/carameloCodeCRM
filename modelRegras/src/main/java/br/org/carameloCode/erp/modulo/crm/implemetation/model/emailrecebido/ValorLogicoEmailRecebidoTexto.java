...
@ValorLogicoEmailRecebido(calculo = ValoresLogicosEmailRecebido.TEXTO)
public class ValorLogicoEmailRecebidoTexto extends ValorLogicoCalculoGenerico {

    public ValorLogicoEmailRecebidoTexto(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getemailRecebido().getTexto();
    }
