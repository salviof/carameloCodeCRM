...
@ValorLogicoEmailCrm(calculo = ValoresLogicosEmailCrm.ACOESDISPONIVEIS)
public class ValorLogicoEmailCrmAcoesDisponiveis
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailCrmAcoesDisponiveis(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
