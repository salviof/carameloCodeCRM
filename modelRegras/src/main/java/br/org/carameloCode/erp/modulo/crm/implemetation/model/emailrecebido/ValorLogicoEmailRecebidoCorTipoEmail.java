...
@ValorLogicoEmailRecebido(calculo = ValoresLogicosEmailRecebido.CORTIPOEMAIL)
public class ValorLogicoEmailRecebidoCorTipoEmail
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailRecebidoCorTipoEmail(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public EmailRecebido getEnvioEmail() {
