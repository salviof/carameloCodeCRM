...
@ValorLogicoPessoaFisica(calculo = ValoresLogicosPessoaFisica.ATIVO)
public class ValorLogicoPessoaFisicaAtivo extends ValorLogicoPessoaAtivo {

    public ValorLogicoPessoaFisicaAtivo(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
