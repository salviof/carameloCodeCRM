...
public enum CPTipoChamado {
	_ID, _NOME, _DESCRICAO, _RESPONSAVEIS, _TIPODADOS, _TIPOAGENDAMENTOVINCULADO, _METAFILTRODISP, _RELACIONEMANTOFILTRODISP, _RESPONSAVEISDISPONIVEIS, _PODECLIENTECRIAR, _ATIVO;
