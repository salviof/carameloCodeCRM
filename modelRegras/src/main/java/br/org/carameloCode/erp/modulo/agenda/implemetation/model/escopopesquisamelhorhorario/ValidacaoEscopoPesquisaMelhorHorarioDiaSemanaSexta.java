...
@ValidadorEscopoPesquisaMelhorHorario(validador = ValidadoresEscopoPesquisaMelhorHorario.DIASEMANASEXTA)
public class ValidacaoEscopoPesquisaMelhorHorarioDiaSemanaSexta extends ValidacaoGenerica<EscopoPesquisaMelhorHorario> {

    public ValidacaoEscopoPesquisaMelhorHorarioDiaSemanaSexta(
    ...
    public List<WidgetsFormulario> validar(Object pValor) throws ErroValidacao {
        ...
        String diasSemanaAtualizado
                = ValidacaoDisponibilidadeAtdmtPublicoDiasDaSemana
                        .definirValor(getEscopoPesquisaMelhorHorario().getDiasDaSemana(), DayOfWeek.FRIDAY.getValue(), ativo);
        getEscopoPesquisaMelhorHorario().setDiasDaSemana(diasSemanaAtualizado);
        getEscopoPesquisaMelhorHorario().setDiaSemanaSexta(ativo);
