...
@ValorLogicoEnvioEmail(calculo = ValoresLogicosEnvioEmail.UMEMAILATIVO)
public class ValorLogicoEnvioEmailUmEmailAtivo
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEnvioEmailUmEmailAtivo(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
