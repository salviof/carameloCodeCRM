...
@ValorLogicoAtividadeCrmLicacaoRealizada(calculo = ValoresLogicosAtividadeCrmLicacaoRealizada.TIPOBLOQUEIO)
public class ValorLogicoAtividadeCrmLicacaoRealizadaTipoBloqueio
		extends
			ValorLogicoCalculoGenerico {

	ValorLogicoAtividadeCrmLicacaoRealizadaTipoBloqueio(
