...
@ValorLogicoEmailRecebido(calculo = ValoresLogicosEmailRecebido.UMEMAILPRIVADO)
public class ValorLogicoEmailRecebidoUmEmailPrivado
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailRecebidoUmEmailPrivado(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        return getEmailRecebido().isUmEmailPrivado();
    }
