...
@ValorLogicoAtividadeCRMEmailEnvio(calculo = ValoresLogicosAtividadeCRMEmailEnvio.ORCAMENTO)
public class ValorLogicoAtividadeCRMEmailEnvioOrcamento
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoAtividadeCRMEmailEnvioOrcamento(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
