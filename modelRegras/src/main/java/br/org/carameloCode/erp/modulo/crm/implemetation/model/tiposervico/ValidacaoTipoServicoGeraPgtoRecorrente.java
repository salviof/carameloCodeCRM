...
@ValidadorTipoServico(validador = ValidadoresTipoServico.GERAPGTORECORRENTE)
public class ValidacaoTipoServicoGeraPgtoRecorrente extends ValidacaoGenerica<TipoServico> {

    public ValidacaoTipoServicoGeraPgtoRecorrente(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public List<WidgetsFormulario> validar(Object pValor) throws ErroValidacao {
        ...
        if (novoValor) {
            getTipoServico().setGeraPgtoSazonal(false);
        }
        getTipoServico().setGeraPgtoRecorrente(novoValor);
        return null;
    }
