...
@ValidadorReservaHorarioCRM(validador = ValidadoresReservaHorarioCRM.FINALRESERVAATENDENTE)
public class ValidacaoReservaHorarioCRMFinalReservaAtendente
		extends
			ValidacaoGenerica<ReservaHorarioCRM> {

	public ValidacaoReservaHorarioCRMFinalReservaAtendente(
	...
	public List validar(java.lang.Object o) throws ErroValidacao {
		CarameloCode
				...
				.enviarMsgErroAoUsuario(
						"A Validação do campo  Final Reserva Atendente não foi implementada");
