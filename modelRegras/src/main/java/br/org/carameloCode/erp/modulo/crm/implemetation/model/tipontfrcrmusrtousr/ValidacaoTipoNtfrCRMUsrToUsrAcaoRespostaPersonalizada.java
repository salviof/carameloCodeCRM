...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.ACAORESPOSTAPERSONALIZADA)
public class ValidacaoTipoNtfrCRMUsrToUsrAcaoRespostaPersonalizada
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrAcaoRespostaPersonalizada(
