...
@ValorLogicoEstatisticaUsuarioCliente(calculo = ValoresLogicosEstatisticaUsuarioCliente.CHAMDOSRESOLVIDOS)
public class ValorLogicoEstatisticaUsuarioClienteChamdosResolvidos
		extends
			ValorLogicoCalculoGenerico {

	ValorLogicoEstatisticaUsuarioClienteChamdosResolvidos(
