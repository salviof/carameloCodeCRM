...
@ValorLogicoEnvioEmailAtividade(calculo = ValoresLogicosEnvioEmailAtividade.UMEMAILATIVO)
public class ValorLogicoEnvioEmailAtividadeUmEmailAtivo
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEnvioEmailAtividadeUmEmailAtivo(ItfCampoInstanciado pCampo) {
        super(pCampo);
    ...
    public Object getValor(Object... pEntidade) {
        getEnvioEmail().setUmEmailAtivo(true);
        return getEnvioEmail().isUmEmailAtivo();
    }
