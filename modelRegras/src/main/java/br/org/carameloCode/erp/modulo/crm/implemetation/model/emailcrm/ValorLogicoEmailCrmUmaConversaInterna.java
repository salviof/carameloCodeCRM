...
@ValorLogicoEmailCrm(calculo = ValoresLogicosEmailCrm.UMACONVERSAINTERNA)
public class ValorLogicoEmailCrmUmaConversaInterna
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailCrmUmaConversaInterna(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
