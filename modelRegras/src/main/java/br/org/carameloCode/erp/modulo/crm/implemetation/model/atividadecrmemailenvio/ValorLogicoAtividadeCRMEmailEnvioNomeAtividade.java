...
@ValorLogicoAtividadeCRMEmailEnvio(calculo = ValoresLogicosAtividadeCRMEmailEnvio.NOMEATIVIDADE)
public class ValorLogicoAtividadeCRMEmailEnvioNomeAtividade
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoAtividadeCRMEmailEnvioNomeAtividade(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
