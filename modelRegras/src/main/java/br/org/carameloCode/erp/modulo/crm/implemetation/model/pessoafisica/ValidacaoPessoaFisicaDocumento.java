...
@ValidadorPessoaFisica(validador = ValidadoresPessoaFisica.DOCUMENTO)
public class ValidacaoPessoaFisicaDocumento
		extends
			ValidacaoGenerica<PessoaFisica> {

	public ValidacaoPessoaFisicaDocumento(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
