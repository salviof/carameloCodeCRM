...
@ValorLogicoPessoaJuridica(calculo = ValoresLogicosPessoaJuridica.EMAIL)
public class ValorLogicoPessoaJuridicaEmail extends ValorLogicoCalculoGenerico {

    public ValorLogicoPessoaJuridicaEmail(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
