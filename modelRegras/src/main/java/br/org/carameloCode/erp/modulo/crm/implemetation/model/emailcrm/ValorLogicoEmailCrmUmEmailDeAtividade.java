...
@ValorLogicoEmailCrm(calculo = ValoresLogicosEmailCrm.UMEMAILDEATIVIDADE)
public class ValorLogicoEmailCrmUmEmailDeAtividade
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailCrmUmEmailDeAtividade(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
