...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.NOTIFICARVIAMOBILE)
public class ValidacaoTipoNtfCRMPersonalizadaNotificarViaMobile
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaNotificarViaMobile(
