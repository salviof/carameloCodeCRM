...
@ValorLogicoEmailRecebido(calculo = ValoresLogicosEmailRecebido.UMACONVERSAEXTERNA)
public class ValorLogicoEmailRecebidoUmaConversaExterna
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailRecebidoUmaConversaExterna(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
