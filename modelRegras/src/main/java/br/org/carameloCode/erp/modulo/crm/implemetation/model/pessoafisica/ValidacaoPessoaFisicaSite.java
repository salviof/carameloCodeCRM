...
public class ValidacaoPessoaFisicaSite extends ValidacaoGenerica<PessoaFisica> {
    ...
    public ValidacaoPessoaFisicaSite(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public List<WidgetsFormulario> validar(Object pValor) throws ErroValidacao {
        ...
        //  }
        getPessoa().getComoPessoaFisica().setSite(pValor.toString());
        String site = (String) getPessoa().getCampoInstanciadoByNomeOuAnotacao("site").getValor();
