...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.CAMINHOUSUARIODESTINATARIO)
public class ValidacaoTipoNtfrCRMUsrToUsrCaminhoUsuarioDestinatario
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrCaminhoUsuarioDestinatario(
