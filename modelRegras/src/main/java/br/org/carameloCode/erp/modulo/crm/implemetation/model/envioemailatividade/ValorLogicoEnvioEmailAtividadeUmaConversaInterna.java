...
@ValorLogicoEnvioEmailAtividade(calculo = ValoresLogicosEnvioEmailAtividade.UMACONVERSAINTERNA)
public class ValorLogicoEnvioEmailAtividadeUmaConversaInterna
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEnvioEmailAtividadeUmaConversaInterna(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }

    @Override
    public Object getValor(Object... pEntidade) {
        getEnvioEmail().setUmaConversaInterna(false);
        return getEnvioEmail().isUmaConversaInterna();
    }
