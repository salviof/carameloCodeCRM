...
@ValorLogicoEmailCrm(calculo = ValoresLogicosEmailCrm.UMEMAILRESPOSTA)
public class ValorLogicoEmailCrmUmEmailResposta
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoEmailCrmUmEmailResposta(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
}
