...
@ValorLogicoSolicitacaoArquivoEquipe(calculo = ValoresLogicosSolicitacaoArquivoEquipe.NOTIFICACAO)
public class ValorLogicoSolicitacaoArquivoEquipeNotificacao
        extends
        ValorLogicoSolicitacaoNotificacao {

    public ValorLogicoSolicitacaoArquivoEquipeNotificacao(
