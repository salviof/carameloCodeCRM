...
@ValorLogicoSolicitacaoAcessoCard(calculo = ValoresLogicosSolicitacaoAcessoCard.EMATRASO)
public class ValorLogicoSolicitacaoAcessoCardEmAtraso
		extends
			ValorLogicoCalculoGenerico {

	public ValorLogicoSolicitacaoAcessoCardEmAtraso(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
