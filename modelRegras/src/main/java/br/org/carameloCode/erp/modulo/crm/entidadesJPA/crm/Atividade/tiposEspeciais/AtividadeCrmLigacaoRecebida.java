 ...
 */
@Entity
@InfoObjetoSB(tags = "Ligação recebida", plural = "Ligações recebidas", modulo = ERPCrm.NOME_MODULO_ERP)
public class AtividadeCrmLigacaoRecebida extends AtividadeCRM {
