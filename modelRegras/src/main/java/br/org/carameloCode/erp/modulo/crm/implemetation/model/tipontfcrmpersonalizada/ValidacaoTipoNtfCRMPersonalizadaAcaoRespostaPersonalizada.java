...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.ACAORESPOSTAPERSONALIZADA)
public class ValidacaoTipoNtfCRMPersonalizadaAcaoRespostaPersonalizada
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaAcaoRespostaPersonalizada(
