...
@ValidadorTipoNtfCRMPersonalizada(validador = ValidadoresTipoNtfCRMPersonalizada.NOTIFICARVIAAPIPERSONALIZADA)
public class ValidacaoTipoNtfCRMPersonalizadaNotificarViaApiPersonalizada
		extends
			ValidacaoGenerica<TipoNtfCRMPersonalizada> {

	public ValidacaoTipoNtfCRMPersonalizadaNotificarViaApiPersonalizada(
	...
	public List validar(java.lang.Object o) throws ErroValidacao {
		CarameloCode
				...
				.enviarMsgErroAoUsuario(
						"A Validação do campo  Notificar Via Api Personalizada não foi implementada");
