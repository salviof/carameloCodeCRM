...
@ValidadorTipoNtfrCRMUsrToUsr(validador = ValidadoresTipoNtfrCRMUsrToUsr.NOTIFICARVIATELADEBLOQUEIO)
public class ValidacaoTipoNtfrCRMUsrToUsrNotificarViaTelaDeBLoqueio
		extends
			ValidacaoGenerica<TipoNtfrCRMUsrToUsr> {

	public ValidacaoTipoNtfrCRMUsrToUsrNotificarViaTelaDeBLoqueio(
