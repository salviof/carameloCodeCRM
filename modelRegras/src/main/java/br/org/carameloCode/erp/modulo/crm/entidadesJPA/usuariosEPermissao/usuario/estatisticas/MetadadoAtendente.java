...
public class MetadadoAtendente extends EntidadeSimples {
    ...
    @InfoCampoValorLogico(nomeCalculo = "Reservas em aberto")
    @InfoCampo(tipo = FabTipoAtributoObjeto.QUANTIDADE)
    private long solicitacoesFeitasPorMimEquipe;
    @InfoCampoValorLogico(nomeCalculo = "Reservas em aberto")
    @InfoCampo(tipo = FabTipoAtributoObjeto.QUANTIDADE)
    private long solicitacoesFeitasParaMim;
    @InfoCampoValorLogico(nomeCalculo = "Reservas em aberto")
    @InfoCampo(tipo = FabTipoAtributoObjeto.QUANTIDADE)
    private long solicitacoesFeitasPorMimParaClientes;
    ...
    public long getSolicitacoesFeitasPorMimEquipe() {
        return solicitacoesFeitasPorMimEquipe;
    }

    public void setSolicitacoesFeitasPorMimEquipe(long solicitacoesFeitasPorMimEquipe) {
        this.solicitacoesFeitasPorMimEquipe = solicitacoesFeitasPorMimEquipe;
    }

    public long getSolicitacoesFeitasParaMim() {
        return solicitacoesFeitasParaMim;
    }

    public void setSolicitacoesFeitasParaMim(long solicitacoesFeitasParaMim) {
        this.solicitacoesFeitasParaMim = solicitacoesFeitasParaMim;
    }

    public long getSolicitacoesFeitasPorMimParaClientes() {
        return solicitacoesFeitasPorMimParaClientes;
    }

    public void setSolicitacoesFeitasPorMimParaClientes(long solicitacoesFeitasPorMimParaClientes) {
        this.solicitacoesFeitasPorMimParaClientes = solicitacoesFeitasPorMimParaClientes;
    }
