...
@ValorLogicoMetadadoAtendente(calculo = ValoresLogicosMetadadoAtendente.CLIENTESINSATISFEITOS)
public class ValorLogicoMetadadoAtendenteClientesInsatisfeitos
        extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoMetadadoAtendenteClientesInsatisfeitos(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public Object getValor(Object... pEntidade) {
        if (getMetadado().getUsuario() != null) {
            if (!isCacheAtivado()) {
                ...
                consulta.addCondicaoManyToOneIgualA(FabSatisfacaoCliente.INSATISFEITO.getRegistro());
