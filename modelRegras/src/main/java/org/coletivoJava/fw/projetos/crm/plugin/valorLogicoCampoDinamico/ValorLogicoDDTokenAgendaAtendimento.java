 ...
 * @author salvio
 */
public class ValorLogicoDDTokenAgendaAtendimento extends
        ValorLogicoCalculoGenerico {

    public ValorLogicoDDTokenAgendaAtendimento(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public Object getValor(Object... pEntidade) {
        ...
        usuarioAtendimento = contato.getProspecto().getUsuarioAtendimento();
        ...
        String tokenFInalURL = token.getCodigo() + "-" + token.getId() + "/.html";
        getDadoDinamico().setValorEmpacotado(tokenFInalURL);
