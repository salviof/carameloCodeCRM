 ...
 * @author salvio
 */
public class TesteSincronizarTypebotFormularios extends TesteCRMCarameloCodeSemLimparBanco {
    ...
    public void testFormularioSincronizar() {
        ...
        ItfRespostaAcaoDoSistema result = ModuloCRMAplicacao.formularioSincronizar();
