...
@CucumberOptions(features = "classpath:caracteristicas", tags = "@EnvioOrcamentoFatura",
        glue = "org.coletivoJava.fw.projetos.Intranet_Marketing_Digital.implementacao.cucumber.envioorcamentofatura.etapas",
        monochrome = false, dryRun = false
)
public class FluxoEnvioOrcamento extends TesteIntegracaoFuncionalidadeCucumber {
