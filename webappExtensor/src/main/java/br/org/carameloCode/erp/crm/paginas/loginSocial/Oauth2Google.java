 ...
 * @author salvio
 */
public class Oauth2Google implements OAuthStrategyBase {
    ...
    public Oauth2Google(final OAuthConfig config, final Map<String, String> endpoints) {
    ...
    @Override
    public String getLoginRedirectURL(String pUrlRecepcaoCodigoDeSolicitacao,
            Map<String, String> requestParams) throws Exception {
        LOG.info("Determining URL for redirection");
        providerState = true;
        try {
            this.successUrl = URLEncoder.encode(pUrlRecepcaoCodigoDeSolicitacao, Constants.ENCODING);
        } catch (UnsupportedEncodingException e) {
            this.successUrl = pUrlRecepcaoCodigoDeSolicitacao;
        }
    ...
    public AccessGrant verifyResponse(final Map<String, String> requestParams,
        ...
        if (code == null || code.length() == 0) {
            throw new SocialAuthException("O código de autorização não foi enviado");
        }
