...
@Named
@ApplicationScoped
public class AcoesAdminCrm_TipoDadoDinamicoIaMbGestao implements Serializable {

	public ItfAcaoFormulario getTipoDadoDinamicoIaMbGestao() {
		return (ItfAcaoFormulario) MapaAcoesSistema
				.getAcaoDoSistemaByNomeUnico("FabAcaoCrmAdmin.TIPO_DADO_DINAMICO_IA_MB_GESTAO");
	}
